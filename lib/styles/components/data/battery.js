...
.simple-bar--widgets-background-color-as-foreground .battery {
  ...
  border: 2px solid rgba(200, 137, 155, 0.20);
}
...
.simple-bar--widgets-background-color-as-foreground .battery__filler {
  background-color: rgba(200, 137, 155, .20);
}
.battery--low .battery__filler {
  background-color: rgba(218, 113, 103, .4);
}
`;
